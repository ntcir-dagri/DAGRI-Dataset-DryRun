...
# python3 baseline.py -f fit-qa_test_dryrun_v2.jsonl -i png --model Qwen/Qwen3-VL-8B-Instruct --api_key "" --base_url http://localhost:8000/v1 --temperature 0.0 -o prediction_qwen.jsonl
# python3 baseline.py -f fit-qa_test_dryrun_v2.jsonl -i png --model gpt-5.4 -o prediction_gpt.jsonl
